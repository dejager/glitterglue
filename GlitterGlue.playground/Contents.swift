...
* mobile device.
* Progam your own shader function in `glitterIsMyFavoriteColor` in Glitter.metal. You
...
do {
  let path = Bundle.main.path(forResource: "Glitter", ofType: "metal")
...
renderer.functionName = "glitterIsMyFavoriteColor"
